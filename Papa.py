...
__author__ = 'ASAD ALI'
__copyright = 'All rights reserved . Copyright  Asad'
...
def reg():
    ...
    print logo
    print ''
    print '   \x1b[1;92m            UPDATE BY ASAD ALI'
    time.sleep(5)
    os.system('clear')
    print logo
    print ''
    print '\x1b[1;31;1mLOGIN KI LIYE APPROVAL LYLO PEHLY BACHY '
    print ''
    time.sleep(3)
    try:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\x1b[1;31;1m[KAMI-CP] ' + uid + ' | ' + pass1
                cp = open('KAMI_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                if 'loc' in q:
                    ...
                    print '\x1b[1;31;1m[KAMI-CP] ' + uid + ' | ' + pass2
                    cp = open('KAMI_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;31;1m[KAMI-CP] ' + uid + ' | ' + pass3
                        cp = open('KAMI_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'loc' in q:
                            ...
                            print '\x1b[1;31;1m[KAMI-CP] ' + uid + ' | ' + pass4
                            cp = open('KAMI_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'loc' in q:
                                ...
                                print '\x1b[1;31;1m[KAMI-CP] ' + uid + ' | ' + pass5
                                cp = open('KAMI_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'loc' in q:
                                    ...
                                    print '\x1b[1;31;1m[KAMI-CP] ' + uid + ' | ' + pass6
                                    cp = open('KAMI_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    if 'loc' in q:
                                        ...
                                        print '\x1b[1;31;1m[KAMI-CP] ' + uid + ' | ' + pass7
                                        cp = open('KAMI_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        if 'loc' in q:
                                            ...
                                            print '\x1b[1;31;1m[KAMI-CP] ' + uid + ' | ' + pass8
                                            cp = open('KAMI_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            if 'loc' in q:
                                                ...
                                                print '\x1b[1;31;1m[KAMI-CP] ' + uid + ' | ' + pass9
                                                cp = open('KAMI_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
